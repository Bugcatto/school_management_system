...
function createTimeDrivenCodgen() {
  // Create a time-driven trigger that runs the 'callbackup7' every day at 6 AM
  ScriptApp.newTrigger('addRandomCodeWithDate')
    .timeBased()
    .everyDays(1)          // Set the trigger to run every day
    .atHour(6)            // Set the time to run at 6 AM
    .create();
}
