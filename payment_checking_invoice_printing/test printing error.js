function printTransactiontesting() {
...
//  }
  ...
  if (iStatus === 'No' && aStatus === 'Yes') {
    ...
    const invoice = createInvoiceForStudent2(transaction, invoiceTemplateSheet, ss.getId());
...
function createInvoiceForStudent2(transactions, templateSheet, ssId) {
  //Logger.log ("step1");
